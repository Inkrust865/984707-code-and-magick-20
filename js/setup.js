...
var getRandomName = function (wizardIndex) {
  ...
  window.WIZARDS[wizardIndex].name = WIZARD_NAMES[indexName] + ' ' + WIZARD_SURNAMES[indexSurname];
  return window.WIZARDS[wizardIndex].name;
};

var getRandomCoatColor = function (wizardIndex) {
  var indexCoatColor = getRandomIndex(WIZARD_COAT_COLOR);
  window.WIZARDS[wizardIndex].coatColor = WIZARD_COAT_COLOR[indexCoatColor];
  return window.WIZARDS[wizardIndex].coatColor;
};

var getRandomEyesColor = function (wizardIndex) {
  var indexEyesColor = getRandomIndex(WIZARD_EYES_COLOR);
  window.WIZARDS[wizardIndex].eyesColor = WIZARD_EYES_COLOR[indexEyesColor];
  return window.WIZARDS[wizardIndex].eyesColor;
};
